...
def train_one_episode(policy_net, actor, critic, ppo_steps, ppo_clip, optimizer, discount_factor):
    policy_net.train()
    log_prob_actions = []
    rewards = []
    values = []
...
def update_policy(policy_net, advantages, log_prob_actions, discounted_rewards, values, states, actions, ppo_steps, ppo_clip, optimizer):
    total_policy_loss = 0 
    total_value_loss = 0
